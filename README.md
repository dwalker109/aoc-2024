...
that quick (c. 100 - 200ms per part) - but I'll go with it. Mutably traversing
lists from both directions can be a bit gory in rust, but what I have here isn't
horrific so there's that, at least. Not my best day, not my worst.

### Timings

```
Part 1: 6415184586041 (236.732895ms)
Part 2: 6436819084274 (122.444291ms)
```